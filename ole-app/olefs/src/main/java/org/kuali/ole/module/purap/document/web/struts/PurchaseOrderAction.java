...
import org.kuali.ole.module.purap.document.service.FaxService;
...
import org.kuali.ole.module.purap.document.validation.event.AttributedAddVendorToQuoteEvent;
...
public class PurchaseOrderAction extends PurchasingActionBase {
    ...
    public ActionForward refresh(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String newStipulation = request.getParameter(OLEPropertyConstants.DOCUMENT + "." + PurapPropertyConstants.VENDOR_STIPULATION_DESCRIPTION);
     ...
     * @return An ActionForward
     * @throws Exception
     * @see org.kuali.ole.module.purap.document.PurchaseOrderReopenDocument
     */
     ...
     * @return An ActionForward
     * @throws Exception
     * @see org.kuali.ole.module.purap.document.PurchaseOrderAmendmentDocument
     */
     ...
     * @return An ActionForward
     * @throws Exception
     * @see org.kuali.ole.module.purap.document.PurchaseOrderVoidDocument
     */
     ...
     * @return An ActionForward
     * @throws Exception
     * @see org.kuali.ole.module.purap.document.PurchaseOrderSplitDocument
     */
    ...
    public ActionForward continuePurchaseOrderSplit(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (!rulePassed) {
            ...
            // Following code block commented as Notes is not saved for the document from here.
            /*try {
    ...
    public ActionForward firstTransmitPrintPo(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String label = SpringContext.getBean(DataDictionaryService.class).getDocumentLabelByTypeName(OLEConstants.FinancialDocumentTypeCodes.PURCHASE_ORDER);
...
//            kualiDocumentFormBase.populateAuthorizationFields(documentAuthorizer);
    ...
    public ActionForward printingRetransmitPo(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String label = SpringContext.getBean(DataDictionaryService.class).getDocumentLabelByTypeName(OLEConstants.FinancialDocumentTypeCodes.PURCHASE_ORDER);
        request.setAttribute("purchaseOrderLabel", label);
        if (po != null && po.getPurchaseOrderRetransmissionMethodCode() != null && po.getPurchaseOrderRetransmissionMethodCode().equals("PRIN")) {
            return mapping.findForward("retransmitPurchaseOrderPDF");
        } else {
            ActionForward forward = new ActionForward(displayPOTabbedPageUrl, true);
            return forward;
        }
    }
    ...
    public ActionForward addStipulation(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (StringUtils.isBlank(poForm.getNewPurchaseOrderVendorStipulationLine().getVendorStipulationDescription())) {
            GlobalVariables.getMessageMap().putError(OLEConstants.DOCUMENT_PROPERTY_NAME + "." + PurapPropertyConstants.VENDOR_STIPULATION, PurapKeyConstants.ERROR_STIPULATION_DESCRIPTION);
        } else {
...
//        message = StringUtils.replace(message, "{0}", tempRows);
        ...
        if (question == null) {
            // ask question if not already asked
            return performQuestionWithoutInput(mapping, form, request, response, PODocumentsStrings.CONFIRM_AWARD_QUESTION, awardedVendorInfo.toString(), OLEConstants.CONFIRMATION_QUESTION, PODocumentsStrings.CONFIRM_AWARD_RETURN, "");
        } else {
            Object buttonClicked = request.getParameter(OLEConstants.QUESTION_CLICKED_BUTTON);
    ...
    protected ActionForward askSaveQuestions(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response, String questionType) {
        ...
        if (StringUtils.equals(questionType, PODocumentsStrings.MANUAL_STATUS_CHANGE_QUESTION) && ObjectUtils.isNull(question)) {
            ...
            String noteText = notePrefix + OLEConstants.BLANK_SPACE + reason;
            int noteTextLength = noteText.length();
    ...
    /**
     * @see org.kuali.ole.module.purap.document.web.struts.PurchasingAccountsPayableActionBase#loadDocument(org.kuali.rice.kns.web.struts.form.KualiDocumentFormBase)
     */
    @Override
